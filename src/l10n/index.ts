...
const langs: Record<string, Record<string, string>> = {
  en: {
    ...
    login: 'Log in',
    welcome: "Hi, I'm DevHelper，your AI-Infused code copilot. Log in and start an AI journey!",
    'msg.signin': 'Sign in to use DevHelper.',
    'msg.empty_selection': 'No code selected!',
    dismiss: 'Dismiss',
    'login.success': 'Login success',
    'chat.login': 'I am going to login...',
    'login.fail': 'DevHelper: Not login or login expired',
  ...
  'zh-cn': {
    ...
    setting: '高级设置',
    login: '立即登录',
    welcome: '你好，我是DevHelper，你的AI代码助理。登录并开始AI之旅吧！',
    'msg.signin': '登录以使用DevHelper。',
    'msg.empty_selection': '未选中任何代码!',
    dismiss: '忽略',
    'login.success': '登录成功',
    'chat.login': '准备重新登录...',
    'login.fail': 'DevHelper: 未登录或者登录过期',
